...
> **Nature:** This document defines **how Atlas reasons**. It is not *what Atlas knows* ([`table-tennis-knowledge.md`](table-tennis-knowledge.md)), not *how coaches think* ([`coaching-dna.md`](coaching-dna.md)), not how software or AI models work. It contains no implementation, architecture, prompts, APIs, databases, pseudocode, or technology-specific language — by design.
